...
/* @author  Borisov Andrey*/

public class Game extends JFrame {
 
    private static Game game_game;
    private static long last_frame_time;
    private static Image lazarev;
    ...
    public static void main(String[] args) throws IOException {
       lazarev = ImageIO.read(Game.class.getResourceAsStream("lazarev.png"));
    ...
    private static void onRepaint(Graphics g){
        ...
        g.drawImage(lazarev, 0, 0, null);
        g.drawImage(ball, (int) drop_left, (int) drop_top, null);
